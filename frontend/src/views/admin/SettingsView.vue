...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/DDAICHICAO/sub2api/blob/codex/my-feature/docs/PAYMENT_CN.md"
    : "https://github.com/DDAICHICAO/sub2api/blob/codex/my-feature/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/DDAICHICAO/sub2api/blob/codex/my-feature/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/DDAICHICAO/sub2api/blob/codex/my-feature/docs/PAYMENT.md#supported-payment-methods",
);
