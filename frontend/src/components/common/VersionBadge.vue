...
const GITHUB_REPO = 'DDAICHICAO/sub2api'
// GHCR image published by this fork (tags carry no "v" prefix, e.g. ghcr.io/ddaichicao/sub2api:0.1.146)
const DOCKER_IMAGE = 'ghcr.io/ddaichicao/sub2api'
