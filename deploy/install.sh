...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/DDAICHICAO/sub2api/codex/my-feature/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="DDAICHICAO/sub2api"
...
Documentation=https://github.com/DDAICHICAO/sub2api
